...
export const gm79 = [
    // C
    [[x,3,3,1,3,x,0],[-1,-1,-1,3,-1,x,3],[-3,-3,2,3,1,x,6],[3,-1,-1,-1,3,-1,8],[-1,3,2,3,-1,x,6],[3,4,1,3,x,x,8]],
    // -D
    [[x,3,3,1,3,x,2],[-1,-1,-1,3,-1,x,4],[-3,-3,2,3,1,x,7],[3,-1,-1,-1,3,-1,9],[-1,3,2,3,-1,x,7],[3,4,1,3,x,x,9]],
    // D
    [[x,3,3,1,3,x,3],[-1,-1,-1,3,-1,x,5],[-3,-3,2,3,1,x,8],[3,-1,-1,-1,3,-1,10],[-1,3,2,3,-1,x,8],[3,4,1,3,x,x,10]],
    // -E
    [[x,3,3,1,3,x,4],[-1,-1,-1,3,-1,x,6],[-3,-3,2,3,1,x,9],[3,-1,-1,-1,3,-1,11],[-1,3,2,3,-1,x,9],[3,4,1,3,x,x,11]],
    // E
    [[2,0,0,0,2,0,0],[-1,-1,-1,3,-1,x,7],[x,3,3,1,3,x,5],[-3,-3,2,3,1,x,10],[-1,3,2,3,-1,x,10],[2,3,0,2,x,x,0]],
    // F
    [[x,3,3,1,3,x,6],[-1,-1,-1,3,-1,x,8],[-3,-3,2,3,1,x,11],[3,-1,-1,-1,3,-1,0],[-1,3,2,3,-1,x,11],[3,4,1,3,x,x,0]],
    // -G
    [[0,2,1,2,0,2,0],[x,3,3,1,3,x,7],[-1,-1,-1,3,-1,x,9],[-2,-2,1,2,0,x,0],[3,-1,-1,-1,3,-1,2],[3,4,1,3,x,x,2]],
    // G
    [[x,3,3,1,3,x,8],[-3,-3,2,3,1,x,0],[3,-1,-1,-1,3,-1,3],[-1,3,2,3,-1,x,0],[-1,-1,-1,3,-1,x,10],[3,4,1,3,x,x,3]],
    // -A
    [[x,3,3,1,3,x,9],[-3,-3,2,3,1,x,2],[3,-1,-1,-1,3,-1,4],[-1,3,2,3,-1,x,2],[-1,-1,-1,3,-1,x,11],[3,4,1,3,x,x,4]],
    // A
    [[0,0,0,2,0,x,0],[x,3,3,1,3,x,10],[-3,-3,2,3,1,x,3],[3,-1,-1,-1,3,-1,5],[-1,3,2,3,-1,x,3],[3,4,1,3,x,x,5]],
    // -B
    [[-1,-1,-1,3,-1,x,0],[x,3,3,1,3,x,11],[-3,-3,2,3,1,x,4],[3,-1,-1,-1,3,-1,6],[-1,3,2,3,-1,x,4],[3,4,1,3,x,x,6]],
    // B
    [[x,2,2,0,2,x,0],[-1,-1,-1,3,-1,x,2],[-3,-3,2,3,1,x,5],[3,-1,-1,-1,3,-1,7],[-1,3,2,3,-1,x,5],[3,4,1,3,x,x,7]],
  ];
  // m7 9 11
export const gm7911 = [
    // C
