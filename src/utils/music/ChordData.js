...
export const gadd9 = [
    // C
    [[0,3,0,2,3,x,0],[-1,-1,3,3,-1,x,3],[3,1,2,3,x,x,8],[-1,4,3,-1,x,x,10],],
    // -D
    [[-1,-1,3,3,-1,x,4],[3,1,2,3,x,x,9],[-1,4,3,-1,x,x,11]],
    // D
    [[0,3,2,0,x,x,0],[-1,-1,3,3,-1,x,5],[3,1,2,3,x,x,10]],
    // -E
    [[-1,4,3,-1,x,x,0],[-1,-1,3,3,-1,x,6],[3,1,2,3,x,x,11]],
    // E
    [[2,0,1,2,2,0,0],[-1,4,3,-1,x,x,2],[-1,-1,3,3,-1,x,7]],
    // F
    [[3,1,2,3,x,x,0],[-1,4,3,-1,x,x,3],[-1,-1,3,3,-1,x,8],],
    // -G
    [[3,1,2,3,x,x,2],[-1,4,3,-1,x,x,4],[-1,-1,3,3,-1,x,9],],
    // G
    [[3,3,2,0,x,3,0],[-1,4,3,-1,x,x,5],[-1,-1,3,3,-1,x,10],[3,1,2,3,x,x,3]],
    // -A
    [[3,1,2,3,x,x,4],[-1,4,3,-1,x,x,6],[-1,-1,3,3,-1,x,11],],
    // A
    [[0,0,2,2,0,x,0],[-1,4,3,-1,x,x,7],[3,1,2,3,x,x,5]],
    // -B
    [[-1,-1,3,3,-1,x,0],[-1,4,3,-1,x,x,8],[3,1,2,3,x,x,6]],
    // B
    [[-1,-1,3,3,-1,x,2],[-1,4,3,-1,x,x,9],[3,1,2,3,x,x,7]],
  ];
