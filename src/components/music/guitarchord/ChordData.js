...
export const ChordData = [
  ...
  [
    ...
    // M7
    [[0, 0, 0, 2, 3, x, 0],[-1,3,2,3,-1,x,3],[1,2,3,4,x,x,7], [-3, -3, -3,1, x, x, 10]],
    // _7
  ...
  [
    ...
    // M7
    [[-1, -1, -1, 3, 4, x, 0],[-1,3,2,3,-1,x,4],[1,2,3,4,x,x,8], [-3, -3, -3,1, x, x,11]],
    // _7
  ...
  [
    ...
    // dim
    [[x,3,1,3,2,x,4],[1,0,1,0,x,x,0],[-1,3,-1,3,2,-1,10]],
    // dim7
    [[x,3,1,3,2,x,4],[1,0,1,0,x,x,0],[-1,3,-1,3,2,-1,10]],
  ],
  // -E
  [
    ...
    // M7
    [[-3, -3, -3,1, x, x, 0],[-1,3,2,3,-1,x,6],[1,2,3,4,x,x,10]],
    // _7
    ...
    // dim
    [[x,3,1,3,2,x,5],[2,1,2,1,x,x,0],[-1,3,-1,3,2,-1,11]],
    // dim7
    [[x,3,1,3,2,x,5],[2,1,2,1,x,x,0],[-1,3,-1,3,2,-1,11]],
  ],
  // E
  [
    ...
    // M7
    [[0,0,1,1,2,0,0],[-3, -3, -3,1, x, x, 2],[-1,3,2,3,-1,x,7],[1,2,3,4,x,x,11]],
    // _7
    ...
    // dim
    [[x,3,1,3,2,x,6],[2,1,2,1,x,x,2],[0,2,0,2,1,0,0]],
    // dim7
    [[x,3,1,3,2,x,6],[2,1,2,1,x,x,2],[0,2,0,2,1,0,0]],
  ],
  // F
  [
    ...
    // M7
    [[1, -3, -3, -3, x, x, 3],[-3, -3, -3,1, x, x, 3],[0,1,2,3,x,x,0]],
    // _7
    ...
    // dim
    [[x,3,1,3,2,x,7],[2,1,2,1,x,x,3],[-1,3,-1,3,2,-1,0]],
    // dim7
    [[x,3,1,3,2,x,7],[2,1,2,1,x,x,3],[-1,3,-1,3,2,-1,0]],
  ],
  // -G
  [
    ...
    // M7
    [[-3, -3, -3,1, x, x, 4],[-1,3,2,3,-1,x,9],[1,2,3,4,x,x,1]],
    // _7
    ...
    // dim
    [[x,3,1,3,2,x,8],[2,1,2,1,x,x,4],[-1,3,-1,3,2,-1,2]],
    // dim7
    [[x,3,1,3,2,x,8],[2,1,2,1,x,x,4],[-1,3,-1,3,2,-1,2]],
  ],
  // G
  [
    ...
    // M7
    [[-3, -3, -3,1, x, x, 5],[-1,3,2,3,-1,x,10],[1,2,3,4,x,x,2]],
    // _7
    ...
    // dim
    [[x,3,1,3,2,x,9],[2,1,2,1,x,x,5],[-1,3,-1,3,2,-1,3]],
    // dim7
    [[x,3,1,3,2,x,9],[2,1,2,1,x,x,5],[-1,3,-1,3,2,-1,3]],
  ],
  // -A
  [
    ...
    // M7
    [[-3, -3, -3,1, x, x, 6],[-1,3,2,3,-1,x,11],[1,2,3,4,x,x,3]],
    // _7
    ...
    // dim
    [[x,3,1,3,2,x,10],[2,1,2,1,x,x,6],[-1,3,-1,3,2,-1,4]],
    // dim7
    [[x,3,1,3,2,x,10],[2,1,2,1,x,x,6],[-1,3,-1,3,2,-1,4]],
  ],
  // A
  [
    ...
    // M7
    [[-3, -3, -3,1, x, x, 7],[0,2,1,2,0,x,0],[1,2,3,4,x,x,4]],
    // _7
    ...
    // dim
    [[x,3,1,3,2,x,11],[2,1,2,1,x,x,7],[-1,3,-1,3,2,-1,5]],
    // dim7
    [[x,3,1,3,2,x,11],[2,1,2,1,x,x,7],[-1,3,-1,3,2,-1,5]],
  ],
  // -B
  [
    ...
    // M7
    [[-3, -3, -3,1, x, x, 8],[-1,3,2,3,-1,x,0],[1,2,3,4,x,x,5]],
    // _7
    ...
    // dim
    [[x,2,0,2,1,x,0],[2,1,2,1,x,x,8],[-1,3,-1,3,2,-1,6]],
    // dim7
    [[x,2,0,2,1,x,0],[2,1,2,1,x,x,8],[-1,3,-1,3,2,-1,6]],
  ],
  // B
  [
    ...
    // M7
    [[-3, -3, -3,1, x, x, 9],[-1,3,2,3,-1,x,1],[1,2,3,4,x,x,6]],
    // _7
